    ...
    <script>
        window.onload = function() {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                theme: "light2",
                title: {
                    text: "M4.5+ Earthquakes, Past Week"
                },
                axisY: {
                    title: "Magnitude",
                    titleFontSize: 24,
            ...
            $.getJSON("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson", addData);
        }
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbars-rs-food">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="week.php">Past 7 Days</a></li>
            ...
            <div class="col-lg-12">
                ...
                <form class="form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-2">
                    ...
                    <select class="form-control-sm mr-3 event-type-select2">
                        ...
                        <?php
		 $xmlDoc=simplexml_load_file("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.quakeml");
    ...
    <script>
        (function() {
            var FEED = 'https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson'
            var NOW = new Date();
