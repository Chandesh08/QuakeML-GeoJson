            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbars-rs-food">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="day.php">Past Day</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="col-lg-12">
                ...
                <form class="form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-2">
                    <input id="filter2" class="form-control-sm mr-3 w-75" type="text" placeholder="Search" aria-label="Search"><select class="form-control-sm mr-3 event-type-select2">
